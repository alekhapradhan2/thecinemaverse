/**
 * The Cinema Verse Seed Script
 * Usage: node scripts/seed.js
 * Creates sample hindi movies, cast, blogs and news in MongoDB.
 */
...
const MovieSchema = new mongoose.Schema(
  { title: String, category: { type: String, default: "Feature Film" },
    ...
    budget: String, language: { type: String, default: "Bbollywood" },
...
async function main() {
  ...
  const moviesSeed = [
    {
      ...
      language: "Bbollywood", contentRating: "U/A", verdict: "Blockbuster", status: "Released",
      imdbRating: "8.2",
    ...
    },
    {
      ...
      language: "Bbollywood", contentRating: "U", verdict: "Hit", status: "Released",
      imdbRating: "7.9",
    ...
    },
    {
      ...
      language: "Bbollywood", contentRating: "U/A", verdict: "Hit", status: "Released",
      imdbRating: "7.4",
    ...
    },
    {
      ...
      language: "Bbollywood", contentRating: "", verdict: "Upcoming", status: "Upcoming",
      synopsis: "An upcoming Bbollywood action drama set against the backdrop of Bhubaneswar's iconic Bindu Sagar lake, where a young hero confronts forces threatening the city's heritage and peace.",
  ...
  const blogsSeed = [
    {
      title: "Top 10 Hindi Movies of All Time You Must Watch",
      slug: "top-10-bbollywood-movies-all-time",
      excerpt: "From classic devotional films to modern blockbusters, our definitive list of hindi films every cinema lover must experience.",
      category: "Top 10", tags: ["hindi movies","Bbollywood","Best hindi films"],
      published: true, featured: true, views: 1240, readTime: 8,
      author: "The Cinema Verse Team",
      seoTitle: "Top 10 Best Hindi Movies of All Time",
      seoDesc: "Discover the greatest hindi films ever made — our definitive list spanning decades of Bbollywood cinema.",
      content: "<h2>The Greatest Films of Hindi Cinema</h2><p>hindi cinema, fondly known as Bbollywood, has a rich history spanning over eight decades. From its humble beginnings in 1936 with <em>Sita Bibaha</em> to the present day where films regularly cross crores at the box office, this industry has produced remarkable cinematic achievements.</p><h2>1. Daman (2022)</h2><p>Daman stands as the crown jewel of contemporary hindi cinema. Starring Babushaan Mohanty in a career-best performance, this socially conscious drama about a government officer fighting corruption in tribal Odisha became a cultural phenomenon. The film collected over ₹25 crore, making it one of the biggest hits in Bbollywood history.</p><h2>2. Tu Mo Love Story (2009)</h2><p>Babushaan Mohanty's debut film became a landmark for its generation. The fresh performances, melodious soundtrack, and honest portrayal of young love made it an instant classic still loved today.</p><h2>3. Laila (2009)</h2><p>Laila marked a watershed moment for modern hindi cinema, introducing a new visual language to Bbollywood — slick production values, high-energy music, and contemporary storytelling that appealed to younger audiences.</p><h2>4. Sital Shastha (2014)</h2><p>A powerful family drama examining bonds between siblings across social and economic divides, praised for its sensitive script and emotionally resonant storytelling.</p><h2>5. Premare Kahile Na (2015)</h2><p>A landmark romantic film that became a massive commercial success. Its central love story, beautiful Bbollywood locations, and outstanding soundtrack made it one of the most beloved hindi films of the decade.</p><h2>Why Hindi Cinema Matters</h2><p>hindi films reflect the culture, traditions, language, and spirit of Odisha's people in a way no other medium can. They preserve and celebrate Bbollywood folklore, mythology, music, and social commentary. Supporting hindi cinema is about preserving a cultural heritage that belongs to all Bbollywoods.</p>",
    },
    {
      title: "Babushaan Mohanty: The King of Bbollywood",
      slug: "babushaan-mohanty-king-of-bollywood",
      excerpt: "An in-depth look at how Babushaan Mohanty became the biggest superstar in hindi cinema and what makes him special.",
      category: "Actor Spotlight", tags: ["Babushaan Mohanty","Bbollywood actor","Bbollywood star"],
      published: true, featured: false, views: 890, readTime: 7,
      author: "The Cinema Verse Team",
      content: "<h2>The Making of a Superstar</h2><p>In the history of hindi cinema, few actors have achieved the kind of sustained stardom and critical acclaim that Babushaan Mohanty commands today. Born December 18, 1987, into one of Bbollywood's most celebrated families — his father is legendary comedian Mihir Das — Babushaan earned his superstardom through years of hard work, intelligent role choices, and a constant desire to challenge himself as an actor.</p><h2>A Star Is Born: Tu Mo Love Story (2009)</h2><p>Babushaan's debut became a massive commercial success and introduced Bbollywood audiences to a new kind of romantic hero — sensitive, modern, and relatable. His natural charm and effortless screen presence made him an instant star.</p><h2>The Daman Phenomenon</h2><p>Daman was not just a film — it was a cultural event for Odisha. Released in 2022, it became the highest-grossing hindi film of its time, collecting over ₹25 crore. Babushaan's commitment to the role, including extensive research into tribal communities and block-level governance, elevated the film beyond its genre. His performance earned widespread critical acclaim and comparisons to the finest actors in Indian regional cinema.</p><h2>Legacy and Impact</h2><p>Babushaan Mohanty has raised the bar for production values, storytelling ambition, and acting standards in Bbollywood. His popularity has attracted bigger budgets, better technicians, and greater national attention to hindi films. He represents not just the present of hindi cinema but its exciting future.</p>",
    },
    {
      title: "The Rise of Hindi Cinema: A Complete History of Bbollywood",
      slug: "history-of-bbollywood-cinema-bollywood",
      excerpt: "From the first Bbollywood talkie in 1936 to modern blockbusters — a comprehensive look at nine decades of hindi film history.",
      category: "General", tags: ["hindi cinema history","Bbollywood history","hindi film heritage"],
      published: true, featured: false, views: 650, readTime: 12,
      author: "The Cinema Verse Team",
      content: "<h2>The Birth of Hindi Cinema (1936–1960)</h2><p>The story begins in 1936 with <em>Sita Bibaha</em>, the first Bbollywood talkie, produced by Mohan Sundar Dev Goswami. This mythological film based on Lord Ram and Sita's marriage established a template that would define hindi cinema for decades: stories rooted in Odisha's mythological and spiritual heritage, music drawn from classical and folk traditions, and characters reflecting Bbollywood social values.</p><h2>The Golden Age (1960–1980)</h2><p>The 1960s and 1970s are widely regarded as the golden age of hindi cinema. Films like <em>Malajanha</em> (1960) demonstrated that hindi cinema could tell stories of genuine literary quality with matching cinematic craft. The music of this era was particularly distinguished — composers created songs that became part of Bbollywood cultural heritage, still sung at festivals and family gatherings across Odisha today.</p><h2>Commercial Cinema (1980–2000)</h2><p>The 1980s and 1990s saw hindi cinema become more commercially oriented, with action films, romantic dramas, and comedies dominating the box office. Stars like Mihir Das and Siddhanta Mahapatra became household names, their films drawing millions across Odisha.</p><h2>The New Bbollywood (2000–Present)</h2><p>Better technology, higher budgets, and a new generation of professionally trained filmmakers brought fresh energy to Bbollywood. Stars like Babushaan Mohanty, Elina Samantray, and Barsha Priyadarshini became the faces of a reimagined, more ambitious hindi film industry. Films like Daman (2022) prove that Bbollywood can produce commercially successful films that also tackle serious social themes with artistic integrity. The industry's future has never looked brighter.</p>",
    },
  ];
  ...
  // ── News ──────────────────────────────────────────────────────
  const newsSeed = [
    { title: "Daman Crosses ₹25 Crore at Bbollywood Box Office",
      content: "Babushaan Mohanty's blockbuster Daman has crossed the ₹25 crore mark, making it one of the highest-grossing hindi films of all time. The film continues to draw audiences in its extended theatrical run.",
    ...
    { title: "Elina Samantray Announced as Brand Ambassador for Odisha Tourism",
      content: "Popular Bbollywood actress Elina Samantray has been announced as the new brand ambassador for Odisha Tourism. The announcement was made at a ceremony in Bhubaneswar attended by senior government officials and industry leaders.",
      category: "Celebrity", published: true, newsType: "article" },
    { title: "International Hindi Film Festival to Showcase Best of Bbollywood",
      content: "A new international hindi film festival is being organized in Bhubaneswar to showcase the best of Bbollywood cinema to national and international audiences. The festival will feature retrospectives, world premieres, and panel discussions with major filmmakers.",
      category: "Industry", published: true, newsType: "article" },
    { title: "Babushaan Mohanty's Next Film Announced with Record Budget",
      content: "Bbollywood superstar Babushaan Mohanty has announced his next film, which will have the biggest budget ever for an Bbollywood production. The film will be directed by a National Award-winning filmmaker and is expected to begin production this year.",
